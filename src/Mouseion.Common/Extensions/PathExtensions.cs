...
namespace Mouseion.Common.Extensions
{
    public static class PathExtensions
    {
        ...
        private const string DB = "mouseion.db";
        private const string DB_OLD = "radarr.db";
        private const string DB_RESTORE = "mouseion.restore";
        private const string LOG_DB = "logs.db";

        private static readonly string UPDATE_SANDBOX_FOLDER_NAME = "mouseion_update" + Path.DirectorySeparatorChar;
        private static readonly string UPDATE_PACKAGE_FOLDER_NAME = "Mouseion" + Path.DirectorySeparatorChar;
        private static readonly string UPDATE_BACKUP_FOLDER_NAME = "mouseion_backup" + Path.DirectorySeparatorChar;
        private static readonly string UPDATE_BACKUP_APPDATA_FOLDER_NAME = "mouseion_appdata_backup" + Path.DirectorySeparatorChar;
        private static readonly string UPDATE_CLIENT_FOLDER_NAME = "Mouseion.Update" + Path.DirectorySeparatorChar;
        ...
        {
            return Path.Combine(GetUpdateSandboxFolder(appFolderInfo), "Mouseion.Update").ProcessNameToExe();
        }
